    ...
    for controllerIdx = 1:numel(controllerTypes)
        for profileIdx = 1:numel(controllerProfiles)
            for presetIdx = 1:numel(solverPresets)
                remainingRuns = runCount - runIndex + 1;
                fprintf(['\nRun %d of %d (remaining %d)\n' ...
                    '  Scenario: %s\n' ...
                    '  Controller: %s\n' ...
                    '  Profile: %s\n' ...
                    '  Solver preset: %s\n'], ...
                    runIndex, runCount, remainingRuns, ...
                    scenarioNames{idx}, ...
                    controllerTypes{controllerIdx}, ...
                    controllerProfiles{profileIdx}, ...
                    solverPresets{presetIdx});
